...
admin_router.register(r'purchase-order-lines', views_admin.AdminPurchaseOrderLineViewSet, basename='admin-purchase-order-line')
admin_router.register(r'vendor-bills', views_admin.AdminVendorBillViewSet, basename='admin-vendor-bill')
admin_router.register(r'vendor-payments', views_admin.AdminVendorPaymentViewSet, basename='admin-vendor-payment')
