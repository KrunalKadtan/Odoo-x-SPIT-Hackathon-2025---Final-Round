...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='purchase_order',
            field=models.ForeignKey(blank=True, null=True, db_index=True, help_text='Source purchase order for this bill', on_delete=django.db.models.deletion.PROTECT, related_name='vendor_bills', to='products.purchaseorder'),
        ),
        migrations.AddField(
            model_name='vendorbill',
            name='vendor',
            field=models.ForeignKey(blank=True, null=True, db_index=True, help_text='Vendor for this bill', on_delete=django.db.models.deletion.PROTECT, related_name='vendor_bills', to='accounts.contact'),
        ),
        migrations.AddField(
            model_name='vendorbill',
            name='bill_date',
